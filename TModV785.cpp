////////////////////////////////////////////
// TModV785.cpp: Implementation of CAEN
// module V785AC
...
unsigned int TModV785::facqreg[2] = {0x100E, 0x0001};
unsigned int TModV785::fMaxDataVal = 4096;
...
//DataReset of V785, do this after the writting of Geo to the module
int TModV785::DataReset()
{
...
int TModV785::Decode(unsigned int *&data_point)
{
    //CleanChData();
...
int TModV785::WriteCrateNumtoBoard(unsigned int cnum)
{
    if(cnum>MaxCrateNum)
    {
...
int TModV785::WriteGeoToBoard(unsigned int geo)
{
...
unsigned int TModV785::GetChannelData(int chnum)
{
