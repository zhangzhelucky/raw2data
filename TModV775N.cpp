////////////////////////////////////////////
// TModV775N.cpp: Implementation of CAEN
// module V775NAC
...
unsigned int TModV775N::facqreg[2] = {0x100E, 0x0001};
unsigned int TModV775N::fMaxDataVal = 4096;
...
ClassImp(TModV775N)
  ...
  void TModV775N::Initialization()
{
    his1d = new TH1*[fMaxChannel];
    for(unsigned int i=0; i<fMaxChannel; i++) his1d[i] = 0;
}

//DataReset of V775N, do this after the writting of Geo to the module
int TModV775N::DataReset()
{
...
int TModV775N::Decode(unsigned int *&data_point)
{
    //CleanChData();
...
int TModV775N::WriteCrateNumtoBoard(unsigned int cnum)
{
    if(cnum>MaxCrateNum)
    {
...
int TModV775N::WriteGeoToBoard(unsigned int geo)
{
...
unsigned int TModV775N::GetChannelData(int chnum)
{
